...
# words = []
# classes = ["Human", "Bot"]  # Define possible sender classes
# documents = []
# ignoreLetters = ['?', '!', '.', ',']

# # Extract dialogue from dataset
# for dialog in dataset['dialog']:
#     text = dialog['text']
#     sender_class = dialog['sender_class']  # This will be either 'Human' or 'Bot'
    
#     # Tokenize and lemmatize text
#     wordList = nltk.word_tokenize(text)
#     words.extend(wordList)
#     documents.append((wordList, sender_class))  # Append text with sender class
...
#     # Output is a binary array for classes ['Human', 'Bot']
...
# # Training the model
# hist = model.fit(np.array(trainX), np.array(trainY), epochs=10000, batch_size=5, verbose=1)
